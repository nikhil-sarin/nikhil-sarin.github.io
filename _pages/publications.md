...
Below is a curated list of my first-author publications organized by research area.
For a complete list including collaborative works, visit:
- [NASA ADS (significant contributions)](https://ui.adsabs.harvard.edu/search/q=docs(library%2Ff4opabVeQnSyHb9jkl3XZA)&sort=date%20desc%2C%20bibcode%20desc&p_=0)
- [Full NASA ADS profile](https://ui.adsabs.harvard.edu/search/p_=0&q=author%3A%22Sarin%2C%20Nikhil%22&sort=date%20desc%2C%20bibcode%20desc)
- [Google Scholar](https://scholar.google.com/citations?user=iSXCI9YAAAAJ&hl=en)
- [My CV](/files/nikhil_cv.pdf)

---

## Software & Methods

1. **Sarin**, Hübner, Omand et al. (2024), *Redback: A Bayesian inference software package for electromagnetic transients*. MNRAS 527:4. [arXiv](https://arxiv.org/abs/2308.12806) [GitHub](https://github.com/nikhil-sarin/redback)
...
3. **Sarin** & Metzger (2024), *Tidal Disruption Events through the Lens of the Cooling Envelope Model*. ApJL 961:L19. [arXiv](https://arxiv.org/abs/2307.15121)

4. **Sarin** & Rosswog (2024), *Cautionary tales on heating-rate prescriptions in kilonovae*. ApJL 971:L17. [arXiv](https://arxiv.org/abs/2404.07271)
